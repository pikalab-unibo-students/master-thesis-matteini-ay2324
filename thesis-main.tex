...
%
The methodology is based on a \acl{Q/A} mechanism, which guides the users through a structured flow of questions and answers, automating -- behind the scenes -- technical steps to build eventually a fair \ac{AI} system.
%
...
% 2.3 Decision support mechanism (emphasis also on BU awareness)
...
%
Here is the point where \ac{TU} contributes to the process, by implementing scripts and computational operations that are eventually integrated into the final system.
%
...
%
Moreover, \ac{TU} is still useful as source of technical knowledge and assistance for the \ac{BU}.
...
\begin{figure}
    ...
    \caption{Detailed sequence diagrams describing interactions between system components when main domain events occur.}
